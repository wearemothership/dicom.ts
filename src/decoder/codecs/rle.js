...
function decodeRLE(imageFrame, pixelData) {
	if (imageFrame.bitsAllocated === 8) {
		if (imageFrame.planarConfiguration) {
			return decode8Planar(imageFrame, new Int8Array(pixelData));
		}

		return decode8(imageFrame, new Int8Array(pixelData));
	}
	if (imageFrame.bitsAllocated === 16) {
		return decode16(imageFrame, new Int16Array(pixelData));
	}
